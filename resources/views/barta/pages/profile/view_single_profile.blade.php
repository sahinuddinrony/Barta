    ...
    <main class="container max-w-2xl mx-auto space-y-8 mt-8 px-2 min-h-screen">
        ...
        @endif --}}
                    ...
                    <h1 class="font-bold md:text-2xl">{{ $userData->name }}</h1>
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div class="text-gray-900 flex flex-col min-w-0 flex-1">
                                        ...
                                        <a href="{{ route('view_single_profile', ['id' => $post->user_id]) }}" class="font-semibold">
                                            <span class="hover:underline text-gray-900 flex flex-col min-w-0 flex-1">{{ $userData->name }}</span>
                                            <span class=" text-sm text-gray-500 line-clamp-1">{{ '@' . $userData->username }}</span>
                                        </a>
